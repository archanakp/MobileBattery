...
public class NewBatteryFragment extends Fragment implements NewBatteryRecyclerAdapter.Action {
    ...
    private EditText searchByBrand, searchBySKUET, searchBySizeET, batterySize;
...
//    private Boolean listViewClicked = false;
    ...
    private TextView popupMessageTV;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        final View view = inflater.inflate(R.layout.new_battery_fragment, container, false);
...
//        searchBySize();
    ...
    private void setAdapterToRecyclerView() {
        ...
        if (getActivity() != null) {
            ...
            batteryModel = new NewBatteryModel("New");
    ...
    private void init(View view) {
        ...
        popupMessageTV = view.findViewById(R.id.popupMessageTV);
...
//                listViewClicked = false;
    ...
    private void showPopup(String titleText, int color){

        popupMessageTV.setVisibility(View.VISIBLE);
        popupMessageTV.setText(titleText);
        popupMessageTV.setBackgroundColor(color);
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                popupMessageTV.setVisibility(View.GONE);
...
//                                            .setAction("Action", null).show();
                                    ...
                                    form.setVisibility(View.GONE);
                                    newBatteryList.setVisibility(View.VISIBLE);
                                    showPopup("Stock allocated Successfully", Color.GREEN);
...
//                                            .setAction("Action", null).show();
                                    showPopup("Stock is not enough.", Color.RED);
        ...
        if (bQuantity.equals("") || bCostPrice.equals("") || r_s_Price.equals("") || l_r_price.equals("") || h_r_price.equals("")) {
            ...
            if (bSource.equals("Technician")) {
                if (btnClick.equals("add")) {
                    ...
                    map.put("technician_id", String.valueOf(btrySourceID));
                }
                ...
                if (btnClick.equals("add")) {
                    ...
                    map.put("supplier_id", String.valueOf(btrySourceID));
...
//                                fetchBatteryList();
                                setAdapterToRecyclerView();
                                showPopup("Stock Added Successfully", Color.GREEN);
...
//                                fetchBatteryList();
                                ...
                                showPopup("Stock Updated Successfully", Color.GREEN);
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                if (getActivity() != null){
                    if (count == 0)
                        ...
                        batteryModel = new NewBatteryModel("New", "brand", s.toString().toLowerCase());
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                if (getActivity() != null){
                    if (count == 0)
                        ...
                        batteryModel = new NewBatteryModel("New", "sku", s.toString().toLowerCase());
...
//                }
                ...
                if (getActivity() != null){
                    if (name.equals("Supplier")) {
                        ...
                        batteryModel = new NewBatteryModel("New", "source", "Supplier");
                    }else if (name.equals("Technician")) {
                        if (batteryModel !=null )
                            if (batteryModel.liveDataSource.getValue() != null)
                                batteryModel.liveDataSource.getValue().invalidate();
                        batteryModel = new NewBatteryModel("New", "source", "Technician");
                    }else {
                        if (batteryModel !=null )
                            if (batteryModel.liveDataSource.getValue() != null)
                                batteryModel.liveDataSource.getValue().invalidate();
    ...
    public void editBattery(int position) {
        ...
        if (pojo != null) {
            ...
            if (bSource.equals("Supplier")) {
                ...
                btrySourceID = pojo.getSupplier_id();
...
//                                    int p = spinnerAdapter.getPosition("Fritz Wold");
                ...
                btrySourceID = pojo.getTechnician_id();
            ...
            batterySize.setText(pojo.getBattery_size());
...
//                    handle click here
                        ...
                        batterySize.setText(item.getBattery_size());
                        batteryName.clearFocus();
                        productNameListView.setVisibility(View.GONE);
